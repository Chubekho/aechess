...
function EvaluationBar({ evaluation, gameResult, isAnalyzing = true }) {
  let percent = 50;
  let text = "0.0";
  ...
  return (
    <div
      className={clsx(styles.barContainer, {
        [styles.disabled]: !isAnalyzing,
      })}
    >
      <div className={styles.whiteBar} style={{ height: `${percent}%` }}></div>
      <span
        className={clsx(styles.scoreText, { [styles.darkText]: isTextBlack })}
      >
        {text}
      </span>
    </div>
